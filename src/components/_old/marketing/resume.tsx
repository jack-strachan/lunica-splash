...
export function ResumeSection() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex border-b border-border">
      <div
        className={`w-1/2 p-8 font-mono relative z-10 transition-colors duration-500 ${isDarkMode ? "bg-black text-white" : "bg-white text-black"}`}
      >
      ...
      <div className={`w-1/2 relative transition-colors duration-500 ${isDarkMode ? "bg-black" : "bg-white"}`}>
        <Dithering
