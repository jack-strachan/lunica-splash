...
export default function TermsPage() {
  return (
    ...
    >
            ...
            <p className="text-xs font-semibold uppercase leading-relaxed tracking-wide text-foreground/60">
              THESE TERMS OF USE (THESE &ldquo;TERMS&rdquo;) SET FORTH THE
              LEGALLY BINDING TERMS AND CONDITIONS THAT GOVERN YOUR USE OF THE
              SITE. BY ACCESSING OR USING THE SITE, YOU ARE ACCEPTING THESE
              ...
              THE ENTITY THAT YOU REPRESENT). YOU MAY NOT ACCESS OR USE THE SITE
            ...
            <p className="text-xs font-semibold uppercase leading-relaxed tracking-wide text-foreground/60">
              ...
              8.2 ALSO CONTAINS A CLASS ACTION AND JURY TRIAL WAIVER. PLEASE
              READ SECTION 8.2 CAREFULLY.
            </p>
            ...
            <p className="text-xs font-semibold uppercase leading-relaxed tracking-wide text-foreground/60">
              ...
              AND YOU WAIVE YOUR RIGHT TO PARTICIPATE IN A CLASS ACTION LAWSUIT
              OR CLASS-WIDE ARBITRATION; AND (2) YOU ARE WAIVING YOUR RIGHT TO
              PURSUE DISPUTES OR CLAIMS AND SEEK RELIEF IN A COURT OF LAW AND TO
              HAVE A JURY TRIAL.
            </p>
            ...
            <div>
              ...
              <p className="mt-4">
                ...
                for an account (&ldquo;Account&rdquo;) and provide certain
            ...
            <div>
              ...
              <p className="mt-4">
                ...
                any content displayed on the Site; (b) you shall not modify, make
                ...
                service; and (d) except as expressly stated herein, no part of
                the Site may be copied, reproduced, distributed, republished,
                downloaded, displayed, posted or transmitted in any form or by
                any means. Unless otherwise indicated, any future release,
                update, or other addition to functionality of the Site shall be
                subject to these Terms. All copyright and other proprietary
              ...
              <p className="mt-4">
                ...
                provide you with any support or maintenance in connection with
                the Site.
              </p>
              ...
              <p className="mt-4">
                ...
                the Site and its content are owned by Company or Company&rsquo;s
                ...
                in or to such intellectual property rights, except for the
              ...
              <p className="mt-4">
                ...
                the Site (&ldquo;Feedback&rdquo;), you hereby assign to Company
            ...
            <div>
              ...
              <p className="mt-4">
                ...
                attorneys&rsquo; fees, from any claim or demand made by any third
            ...
            <div>
              ...
              <p className="mt-4">
                ...
                &ldquo;Third-Party Links &amp; Ads&rdquo;). Such Third-Party
                ...
                Third-Party Links &amp; Ads, the applicable third party&rsquo;s
                terms and policies apply, including the third party&rsquo;s
              ...
              <p className="mt-4">
                ...
                RELEASE DOES NOT EXTEND TO CLAIMS WHICH THE CREDITOR OR
            ...
            <div>
              ...
              <p className="mt-4 text-xs font-semibold uppercase leading-relaxed tracking-wide text-foreground/60">
                ...
                LIMITED IN DURATION TO 90 DAYS FROM THE DATE OF FIRST USE. SOME
            ...
            <div>
              ...
              <p className="mt-4 text-xs font-semibold uppercase leading-relaxed tracking-wide text-foreground/60">
                ...
                DOLLARS. THE EXISTENCE OF MORE THAN ONE CLAIM WILL NOT ENLARGE
                THIS LIMIT. YOU AGREE THAT OUR SUPPLIERS WILL HAVE NO LIABILITY
                OF ANY KIND ARISING FROM OR RELATING TO THESE TERMS. SOME
            ...
            <div>
              ...
              <p className="mt-4">
                ...
                Account. Even after your rights under these Terms are terminated,
            ...
            <div>
              ...
              <p className="mt-4">
                ...
                (the &ldquo;Arbitration Agreement&rdquo;) carefully. It requires
                ...
                representatives (collectively, the &ldquo;Company
                Parties&rdquo;) and limits the manner in which you can seek
              ...
              <p className="mt-4">
                ...
                the Site (the &ldquo;Services&rdquo;) or these Terms will be
                ...
                shall survive the expiration or termination of these Terms and
                shall apply, without limitation, to all claims that arose or were
                asserted before you agreed to these Terms (in accordance with the
                preamble) or any prior version of these Terms. This Arbitration
                ...
                if the law allows, seek relief against the Company Parties on
                your behalf. For purposes of this Arbitration Agreement,
                &ldquo;Dispute&rdquo; will also include disputes that arose or
                involve facts occurring before the existence of this or any prior
                versions of the Agreement as well as claims that may arise after
              ...
              <p className="mt-4">
                ...
                Agreement (&ldquo;Informal Dispute Resolution
                Conference&rdquo;). If you are represented by counsel, your
                counsel may participate in the conference, but you will also
                participate in the conference. The party initiating a Dispute
                must give notice to the other party in writing of its intent to
                initiate an Informal Dispute Resolution Conference
                (&ldquo;Notice&rdquo;), which shall occur within 45 days after
                ...
                account (if you have one); (2) the name, telephone number,
                mailing address and e-mail address of your counsel, if any; and
                (3) a description of your Dispute. The Informal Dispute
                Resolution Conference shall be individualized such that a
                separate conference must be held each time either party initiates
                a Dispute, even if the same law firm or group of law firms
                represents multiple users in similar cases, unless all parties
                agree; multiple individuals initiating a Dispute cannot
                ...
                the Notice and the Informal Dispute Resolution Conference,
                nothing in this Arbitration Agreement shall prohibit the parties
                from engaging in informal communications to resolve the
                initiating party&rsquo;s Dispute. Engaging in the Informal
              ...
              <p className="mt-4">
                ...
                and notwithstanding any other provision herein with respect to
                the applicable substantive law, the Federal Arbitration Act, 9
                U.S.C. &sect; 1 et seq., will govern the interpretation and
                ...
                above does not resolve satisfactorily within 60 days after
                receipt of your Notice, you and Company agree that either party
                shall have the right to finally resolve the Dispute through
                ...
                address of the party seeking arbitration and the account username
                (if applicable) as well as the email address associated with any
                applicable account; (2) a statement of the legal claims being
                asserted and the factual bases of those claims; (3) a description
                of the remedy sought and an accurate, good-faith calculation of
                the amount in controversy in United States Dollars; (4) a
                statement certifying completion of the Informal Dispute
                Resolution process as described above; and (5) evidence that the
                requesting party has paid any necessary filing fees in connection
                with such arbitration. If the party requesting arbitration is
                represented by counsel, the Request shall also include
                counsel&rsquo;s name, telephone number, mailing address, and
                email address. Such counsel must also sign the Request. By
                signing the Request, counsel certifies to the best of
                counsel&rsquo;s knowledge, information, and belief, formed after
                an inquiry reasonable under the circumstances, that: (1) the
                ...
                fees and costs will be solely as set forth in the applicable JAMS
                Rules. You and Company agree that all materials and documents
                exchanged during the arbitration proceedings shall be kept
                confidential and shall not be shared with anyone except the
                parties&rsquo; attorneys, accountants, or business advisors, and
                then subject to the condition that they agree to keep all
              ...
              <p className="mt-4">
                ...
                subsection entitled &ldquo;Waiver of Class or Other
                Non-Individualized Relief,&rdquo; including any claim that all or
                part of the subsection entitled &ldquo;Waiver of Class or Other
                Non-Individualized Relief&rdquo; is unenforceable, illegal, void
                or voidable, or that such subsection entitled &ldquo;Waiver of
                Class or Other Non-Individualized Relief&rdquo; has been
                ...
                the subsection entitled &ldquo;Batch Arbitration,&rdquo; all
                ...
                provided in the subsection entitled &ldquo;Batch
                Arbitration.&rdquo; The arbitrator shall have the authority to
                ...
                individual party under applicable law, the arbitral forum&rsquo;s
                ...
                award (or decision not to render an award) is based, including
                the calculation of any damages awarded. The arbitrator shall
                follow the applicable law. The award of the arbitrator is final
                and binding upon you and us. Judgment on the arbitration award
              ...
              <p className="mt-4 text-xs font-semibold uppercase leading-relaxed tracking-wide text-foreground/60">
                ...
                BASIS. ONLY INDIVIDUAL RELIEF IS AVAILABLE, AND DISPUTES OF MORE
                THAN ONE CUSTOMER OR USER CANNOT BE ARBITRATED OR CONSOLIDATED
              ...
              <p className="mt-3">
                ...
                relief warranted by the party&rsquo;s individual claim. Nothing
                in this paragraph is intended to, nor shall it, affect the terms
                and conditions under the Subsection 8.2(h) entitled &ldquo;Batch
                Arbitration.&rdquo; Notwithstanding anything to the contrary in
                this Arbitration Agreement, if a court decides by means of a
                final decision, not subject to any further appeal or recourse,
                that the limitations of this subsection, &ldquo;Waiver of Class
                or Other Non-Individualized Relief,&rdquo; are invalid or
                unenforceable as to a particular claim or request for relief
                (such as a request for public injunctive relief), you and Company
                agree that that particular claim or request for relief (and only
                that particular claim or request for relief) shall be severed
                from the arbitration and may be litigated in the state or federal
                courts located in the State of New York. All other Disputes shall
                be arbitrated or litigated in small claims court. This subsection
              ...
              <p className="mt-4">
                ...
                11(b)). If you or Company need to invoke the authority of a court
                of competent jurisdiction to compel arbitration, then the party
                that obtains an order compelling arbitration in such action shall
                have the right to collect from the other party its reasonable
                costs, necessary disbursements, and reasonable attorneys&rsquo;
              ...
              <p className="mt-4">
                ...
                (1) administer the arbitration demands in batches of 100 Requests
                per batch (plus, to the extent there are less than 100 Requests
                left over after the batching described above, a final batch
                consisting of the remaining Requests); (2) appoint one arbitrator
                for each batch; and (3) provide for the resolution of each batch
                as a single consolidated arbitration with one set of filing and
                administrative fees due per side per batch, one procedural
                calendar, one hearing (if any) in a place to be determined by the
                arbitrator, and one final award (&ldquo;Batch
                Arbitration&rdquo;). All parties agree that Requests are of a
                &ldquo;substantially similar nature&rdquo; if they arise out of
                or relate to the same event or factual scenario and raise the
                same or similar legal issues and seek the same or similar relief.
                To the extent the parties disagree on the application of the
                Batch Arbitration process, the disagreeing party shall advise the
                JAMS, and the JAMS shall appoint a sole standing arbitrator to
                ...
                set forth such procedures as are necessary to resolve any
                disputes promptly. The Administrative Arbitrator&rsquo;s fees
                shall be paid by Company. You and Company agree to cooperate in
                good faith with the JAMS to implement the Batch Arbitration
                process including the payment of single filing and administrative
                fees for batches of Requests, as well as any steps to minimize
                the time and costs of arbitration, which may include: (1) the
              ...
              <p className="mt-4">
                Except as provided in the subsection entitled &ldquo;Waiver of
                Class or Other Non-Individualized Relief&rdquo;, if any part or
              ...
              <p className="mt-4">
                ...
                Changes to this Arbitration Agreement do not provide you with a
                new opportunity to opt out of the Arbitration Agreement if you
                have previously agreed to a version of these Terms and did not
                validly opt out of arbitration. If you reject any change or
                update to this Arbitration Agreement, and you were bound by an
                existing agreement to arbitrate Disputes arising out of or
                relating in any way to your access to or use of the Services or
                of the Site, any communications you receive, any products sold or
                ...
                Terms) remain in full force and effect. Company will continue to
              ...
              <p className="mt-4">
                ...
                satisfy if it were be in a hardcopy writing. The foregoing does
              ...
              <p className="mt-4">
                ...
                effect. The word &ldquo;including&rdquo; means &ldquo;including
                without limitation&rdquo;. If any provision of these Terms is,
                ...
                transferred by you without Company&rsquo;s prior written
                consent, and any attempted assignment, subcontract, delegation,
              ...
              <p className="mt-4">
                Copyright &copy; 2026 Lunica Technologies, LLC. All rights
                reserved. All trademarks, logos and service marks
                (&ldquo;Marks&rdquo;) displayed on the Site are our property or
              ...
              <div className="mt-4">
                <p>Lunica Technologies, LLC</p>
                <p>169 Madison Avenue, STE 11202</p>
